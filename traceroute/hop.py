...
class Hop:
    ...
    def __init__(self, addr, asn, ttl, reply_ttl, qttl=1, icmp_type=11, icmpext=None, rtt=None):
    ...
    def __repr__(self):
        return 'Hop(Addr={}, ASN={}, TTL={}, QTTL={} ITYPE={}, ICMPEXT={}, RTT={})'.format(self.addr, self.asn, self.ttl, self.qttl, self.icmp_type, bool(self.icmpext), self.rtt)
