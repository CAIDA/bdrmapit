...
def main(vargs=None, _ip2as=None):
    global ip2as, args
    ...
    args = parser.parse_args() if vargs is None else parser.parse_args(vargs)
    if args.files:
    ...
    ip2as = rt.RoutingTable.ip2as(args.ip2as) if _ip2as is None else _ip2as
